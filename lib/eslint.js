...
import validator from "./config/config-validator";
import Environments from "./config/environments";
import CommentEventGenerator from "./util/comment-event-generator";
import NodeEventGenerator from "./util/node-event-generator";
import SourceCode from "./util/source-code";
...
const assert = require("assert"), EventEmitter = require("events").EventEmitter, escope = require("escope"), levn = require("levn"), blankScriptAST = require("../conf/blank-script.json"), DEFAULT_PARSER = require("../conf/eslint.json").parser, replacements = require("../conf/replacements.json"), timing = require("./timing");
