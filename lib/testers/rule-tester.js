...
const lodash = require("lodash"), assert = require("assert"), util = require("util"), validate = require("is-my-json-valid"), metaSchema = require("../../conf/json-schema-schema.json");
 ...
 * @constructor
 */
export default function RuleTester(testerConfig) {
