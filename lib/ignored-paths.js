...
var debug = require("debug")("eslint:ignored-paths");
...
IgnoredPaths.prototype.contains = function (filepath, category) {
    ...
    var relativePath = _pathUtil2.default.getRelativePath(absolutePath, this.options.cwd);
...
IgnoredPaths.prototype.getIgnoredFoldersGlobChecker = function () {
    ...
    return function (absolutePath) {
        var relative = _pathUtil2.default.getRelativePath(absolutePath, base);
