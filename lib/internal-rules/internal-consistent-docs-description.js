...
var ALLOWED_FIRST_WORDS = ["enforce", "require", "disallow"];
...
function checkMetaDocsDescription(context, exportsNode) {
    ...
    var metaProperty = getPropertyFromObject("meta", exportsNode);
    var metaDocs = metaProperty && getPropertyFromObject("docs", metaProperty.value);
    var metaDocsDescription = metaDocs && getPropertyFromObject("description", metaDocs.value);
    ...
    var description = metaDocsDescription.value.value;
    ...
    create: function create(context) {
        return {
            AssignmentExpression: function AssignmentExpression(node) {
                if (node.left && node.right && node.left.type === "MemberExpression" && node.left.object.name === "module" && node.left.property.name === "exports") {
