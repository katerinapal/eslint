...
function updateModifiedFlag(conditions, modifiers) {
    ...
    for (var i = 0; i < conditions.length; ++i) {
        ...
        for (var j = 0; !condition.modified && j < modifiers.length; ++j) {
             ...
             */
            var inLoop = condition.isInLoop(modifier) || Boolean((funcNode = getEncloseFunctionDeclaration(modifier)) && (funcVar = _astUtils2.default.getVariableByName(modifier.from.upper, funcNode.id.name)) && funcVar.references.some(condition.isInLoop));
