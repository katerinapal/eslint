    ...
    create: function create(context) {
        ...
        function reportAccessingEvalViaGlobalObject(globalScope) {
            for (var i = 0; i < candidatesOfGlobalObject.length; ++i) {
                ...
                var variable = _astUtils2.default.getVariableByName(globalScope, name);
        ...
        function reportAccessingEval(globalScope) {
            var variable = _astUtils2.default.getVariableByName(globalScope, "eval");
            ...
            for (var i = 0; i < references.length; ++i) {
                ...
                if (id.name === "eval" && !_astUtils2.default.isCallee(id)) {
        ...
        return {
            ...
            ThisExpression: function ThisExpression(node) {
                ...
                if (!funcInfo.initialized) {
                    ...
                    funcInfo.defaultThis = _astUtils2.default.isDefaultThisBinding(funcInfo.node, sourceCode);
                }
