...
exports.default = {
    ...
    create: function create(context) {
        ...
        function validateCommaItemSpacing(previousItemToken, commaToken, currentItemToken, reportItem) {
            ...
            // if single line
            if (_astUtils2.default.isTokenOnSameLine(commaToken, currentItemToken) && _astUtils2.default.isTokenOnSameLine(previousItemToken, commaToken)) {

                // do nothing.

            } else if (!_astUtils2.default.isTokenOnSameLine(commaToken, currentItemToken) && !_astUtils2.default.isTokenOnSameLine(previousItemToken, commaToken)) {
            ...
            } else if (style === "first" && !_astUtils2.default.isTokenOnSameLine(commaToken, currentItemToken)) {
            ...
            } else if (style === "last" && _astUtils2.default.isTokenOnSameLine(commaToken, currentItemToken)) {
