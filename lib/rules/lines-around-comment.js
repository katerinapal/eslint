...
exports.default = {
    ...
    create: function create(context) {
        ...
        function codeAroundComment(node) {
            ...
            if (token && _astUtils2.default.isTokenOnSameLine(token, node)) {
                return true;
            }
            ...
            if (token && _astUtils2.default.isTokenOnSameLine(node, token)) {
                return true;
            }
        ...
        function checkForEmptyLine(node, opts) {
            ...
            if (!exceptionStartAllowed && before && !lodash.includes(commentAndEmptyLines, prevLineNum) && !(isCommentNodeType(previousTokenOrComment) && _astUtils2.default.isTokenOnSameLine(previousTokenOrComment, node))) {
            ...
            if (!exceptionEndAllowed && after && !lodash.includes(commentAndEmptyLines, nextLineNum) && !(isCommentNodeType(nextTokenOrComment) && _astUtils2.default.isTokenOnSameLine(node, nextTokenOrComment))) {
                context.report({
                    node: node,
