    ...
    create: function create(context) {
        ...
        return {
            BinaryExpression: function BinaryExpression(node) {
                ...
                if (_astUtils2.default.isStringLiteral(left) && _astUtils2.default.isStringLiteral(right) && _astUtils2.default.isTokenOnSameLine(left, right)) {
                    ...
                    context.report(node, operatorToken.loc.start, "Unexpected string concatenation of literals.");
                }
            }
        };
    }
