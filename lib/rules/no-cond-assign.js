...
exports.default = {
    ...
    create: function create(context) {
        ...
        function findConditionalAncestor(node) {
            ...
            } while ((currentAncestor = currentAncestor.parent) && !_astUtils2.default.isFunction(currentAncestor));
        ...
        function isParenthesised(node) {
            ...
            return previousToken.value === "(" && previousToken.range[1] <= node.range[0] && nextToken.value === ")" && nextToken.range[0] >= node.range[1];
        }
        ...
        function isParenthesisedTwice(node) {
            ...
            return isParenthesised(node) && previousToken.value === "(" && previousToken.range[1] <= node.range[0] && nextToken.value === ")" && nextToken.range[0] >= node.range[1];
        }
        ...
        function testForAssign(node) {
            if (node.test && node.test.type === "AssignmentExpression" && (node.type === "ForStatement" ? !isParenthesised(node.test) : !isParenthesisedTwice(node.test))) {
