...
exports.default = {
    ...
    create: function create(context) {
        ...
        function shouldIgnore(node) {
            ...
            return !includesBothInAGroup(options.groups, a.operator, b.operator) || options.allowSamePrecedence && _astUtils2.default.getPrecedence(a) === _astUtils2.default.getPrecedence(b);
        }
        ...
        function isMixedWithParent(node) {
            return node.operator !== node.parent.operator && !_astUtils2.default.isParenthesised(sourceCode, node);
        }
