...
exports.default = {
    ...
    create: function create(context) {
        ...
        function validateCommaItemSpacing(tokens, reportItem) {
            if (tokens.left && _astUtils2.default.isTokenOnSameLine(tokens.left, tokens.comma) && options.before !== sourceCode.isSpaceBetweenTokens(tokens.left, tokens.comma)) {
            ...
            if (tokens.right && _astUtils2.default.isTokenOnSameLine(tokens.comma, tokens.right) && options.after !== sourceCode.isSpaceBetweenTokens(tokens.comma, tokens.right)) {
