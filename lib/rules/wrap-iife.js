    ...
    create: function create(context) {
        ...
        */
        function getFunctionNodeFromIIFE(node) {
            ...
            if (includeFunctionPrototypeMethods && callee.type === "MemberExpression" && callee.object.type === "FunctionExpression" && (_astUtils2.default.getStaticPropertyName(callee) === "call" || _astUtils2.default.getStaticPropertyName(callee) === "apply")) {
