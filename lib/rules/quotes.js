...
exports.default = {
    ...
    create: function create(context) {
        ...
        function isPartOfDirectivePrologue(node) {
            ...
            if (block.type !== "Program" && (block.type !== "BlockStatement" || !_astUtils2.default.isFunction(block.parent))) {
                return false;
            }
        ...
        return {
            Literal: function Literal(node) {
                ...
                if (settings && typeof val === "string") {
                    isValid = quoteOption === "backtick" && isAllowedAsNonBacktick(node) || isJSXLiteral(node) || _astUtils2.default.isSurroundedBy(rawVal, settings.quote);

                    if (!isValid && avoidEscape) {
                        isValid = _astUtils2.default.isSurroundedBy(rawVal, settings.alternateQuote) && rawVal.indexOf(settings.quote) >= 0;
                    }
