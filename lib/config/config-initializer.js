...
import sourcecodeutil_moduleObject from "../util/source-code-util";
...
const util = require("util"), inquirer = require("inquirer"), ProgressBar = require("progress"), getSourceCodeOfFiles = sourcecodeutil_moduleObject.getSourceCodeOfFiles, recConfig = require("../../conf/eslint.json");
