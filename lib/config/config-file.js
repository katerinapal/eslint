import ConfigOps from "./config-ops";
import validator from "./config-validator";
import Plugins from "./plugins";
import pathUtil from "../util/path-util";
import ModuleResolver from "../util/module-resolver";
/**
...
const fs = require("fs"), path = require("path"), shell = require("shelljs"), pathIsInside = require("path-is-inside"), stripBom = require("strip-bom"), stripComments = require("strip-json-comments"), stringify = require("json-stable-stringify"), defaultOptions = require("../../conf/eslint.json"), requireUncached = require("require-uncached");
