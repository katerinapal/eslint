...
import defaultOptions from "../conf/cli-options";
import IgnoredPaths from "./ignored-paths";
import Config from "./config";
import Plugins from "./config/plugins";
import globUtil from "./util/glob-util";
import SourceCodeFixer from "./util/source-code-fixer";
...
const fs = require("fs"), path = require("path"), fileEntryCache = require("file-entry-cache"), stringify = require("json-stable-stringify"), pkg = require("../package.json");
 ...
 * @constructor
 */
export default function CLIEngine(options) {
