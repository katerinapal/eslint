...
var _codePathState = require("./code-path-state");

var _codePathState2 = _interopRequireDefault(_codePathState);
...
function CodePath(id, upper, onLooped) {
    ...
    Object.defineProperty(this, "internal", { value: new _codePathState2.default(new _idGenerator2.default(id + "_"), onLooped) });
...
CodePath.prototype = {
     ...
     * @returns {void}
     */
    traverseSegments: function traverseSegments(options, callback) {
