...
exports.default = CodePathState;

var _codePathSegment = require("./code-path-segment");

var _codePathSegment2 = _interopRequireDefault(_codePathSegment);

var _forkContext = require("./fork-context");

var _forkContext2 = _interopRequireDefault(_forkContext);
...
function makeLooped(state, fromSegments, toSegments) {
    ...
    for (var i = 0; i < end; ++i) {
        ...
        if (toSegment.allPrevSegments.length >= 2) {
            _codePathSegment2.default.markPrevSegmentAsLooped(toSegment, fromSegment);
        }
...
function CodePathState(idGenerator, onLooped) {
    ...
    this.forkContext = _forkContext2.default.newRoot(idGenerator);
...
CodePathState.prototype = {
     ...
     */
    pushForkContext: function pushForkContext(forkLeavingPath) {
        this.forkContext = _forkContext2.default.newEmpty(this.forkContext, forkLeavingPath);
     ...
     * @returns {void}
     */
    pushChoiceContext: function pushChoiceContext(kind, isForkingAsResult) {
        this.choiceContext = {
            upper: this.choiceContext,
            kind: kind,
            isForkingAsResult: isForkingAsResult,
            trueForkContext: _forkContext2.default.newEmpty(this.forkContext),
            falseForkContext: _forkContext2.default.newEmpty(this.forkContext),
            processed: false
        };
    },
     ...
     * @returns {void}
     */
    pushSwitchContext: function pushSwitchContext(hasCase, label) {
        this.switchContext = {
     ...
     * @returns {void}
     */
    makeSwitchCaseBody: function makeSwitchCaseBody(isEmpty, isDefault) {
        var context = this.switchContext;
     ...
     * @returns {void}
     */
    pushTryContext: function pushTryContext(hasFinalizer) {
        this.tryContext = {
            upper: this.tryContext,
            position: "try",
            hasFinalizer: hasFinalizer,

            returnedForkContext: hasFinalizer ? _forkContext2.default.newEmpty(this.forkContext) : null,

            thrownForkContext: _forkContext2.default.newEmpty(this.forkContext),
    ...
    makeCatchBlock: function makeCatchBlock() {
        ...
        context.thrownForkContext = _forkContext2.default.newEmpty(forkContext);
    ...
    makeFinallyBlock: function makeFinallyBlock() {
        ...
        for (var i = 0; i < forkContext.count; ++i) {
            ...
            segments.push(_codePathSegment2.default.newNext(this.idGenerator.next(), prevSegsOfLeavingSegment));
        }
     ...
     * @returns {void}
     */
    pushLoopContext: function pushLoopContext(type, label) {
        var forkContext = this.forkContext;
        ...
        switch (type) {
            ...
            case "DoWhileStatement":
                ...
                this.loopContext = {
                    ...
                    test: void 0,
                    entrySegments: null,
                    continueForkContext: _forkContext2.default.newEmpty(forkContext),
                    brokenForkContext: breakContext.brokenForkContext
                };
                break;
     ...
     * @returns {void}
     */
    makeWhileTest: function makeWhileTest(test) {
        var context = this.loopContext;
        var forkContext = this.forkContext;
     ...
     * @returns {void}
     */
    makeDoWhileTest: function makeDoWhileTest(test) {
        var context = this.loopContext;
        var forkContext = this.forkContext;
     ...
     * @returns {void}
     */
    makeForTest: function makeForTest(test) {
        var context = this.loopContext;
        var forkContext = this.forkContext;
    ...
    makeForBody: function makeForBody() {
        ...
        if (!bodySegments) {
             ...
             */
            var prevForkContext = _forkContext2.default.newEmpty(forkContext);
    ...
    makeForInOfRight: function makeForInOfRight() {
        var context = this.loopContext;
        var forkContext = this.forkContext;
        var temp = _forkContext2.default.newEmpty(forkContext);
     ...
     */
    pushBreakContext: function pushBreakContext(breakable, label) {
        this.breakContext = {
            upper: this.breakContext,
            breakable: breakable,
            label: label,
            brokenForkContext: _forkContext2.default.newEmpty(this.forkContext)
        };
     ...
     * @returns {void}
     */
    makeBreak: function makeBreak(label) {
        var forkContext = this.forkContext;
     ...
     * @returns {void}
     */
    makeContinue: function makeContinue(label) {
        var forkContext = this.forkContext;
