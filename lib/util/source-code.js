...
var _tokenStore = require("../token-store.js");
...
function SourceCode(text, ast) {
    ...
    var tokenStore = (0, _tokenStore2.default)(ast.tokens);

    Object.keys(tokenStore).forEach(function (methodName) {
        this[methodName] = tokenStore[methodName];
    }, this);

    var tokensAndCommentsStore = (0, _tokenStore2.default)(this.tokensAndComments);
